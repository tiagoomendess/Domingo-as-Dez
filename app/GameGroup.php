...
class GameGroup extends Model
{
    ...
    public function getGameByClubNameSlug($round, $home_club_slug, $away_club_slug) {
        ...
        foreach ($games as $game) {
            ...
            if ($round == $game->round && str_slug($game->homeTeam->club->name) == $home_club_slug && str_slug($game->awayTeam->club->name) == $away_club_slug)
                $selected = $game;
        }
