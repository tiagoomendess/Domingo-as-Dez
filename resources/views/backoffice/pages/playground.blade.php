...
@section('content')
    ...
    <div class="row">
        ...
        <div class="input-field col s4 m2 l2">
            <input type="number" name="capacity" id="capacity" class="validate" value="{{ $playground->capacity }}"
                   disabled>
    ...
    <div class="row">
        ...
        <div class="input-field col s6 m4 l3">
            <input type="text" name="surface" id="surface" class="validate autocomplete"
                   value="{{ $playground->surface }}" disabled>
    ...
    <div class="row">
        <div class="input-field col s12 m4 l3">
            <input disabled name="priority" id="priority" type="number" class="validate"
                   value="{{ $playground->priority }}">
    ...
    <div class="row">
        <div class="input-field col s12 m8 l6">
            <textarea disabled id="obs" name="obs" class="materialize-textarea"
                      rows="1">{{ $playground->obs }}</textarea>
