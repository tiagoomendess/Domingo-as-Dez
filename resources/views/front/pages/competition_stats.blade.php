        ...
        <div class="nav-wrapper">
            <div class="container">
                <div class="col s12">
                    ...
                    <a href="{{ route('competition', ['slug' => str_slug($competition->name)]) }}" class="breadcrumb">{{ $competition->name }}</a>
